...
function val(){
    ...
    if(img.value.slice(0, 8)!="https://"){
        img.focus()
        erorrImg.style.display = "block"
        erorrImg.innerHTML = "Rasmning manzili kiritilishi kerak edi. Namuna:https://picsum.photos/seed/picsum/200/300"
        return false
    }else{
        erorrImg.style.display = "none"
        erorrImg.innerHTML = "Rasmning url manzili kiritilishi shart***"
    }
    return true
}
...
const modal = document.querySelector(".wraper")
const cencle = document.querySelector(".close")
const cencle1 = document.querySelector(".close1")
const snd = document.querySelector(".send")
const body = document.querySelector("body")

send.addEventListener("click", function(){
    modal.style.filter.blur = "100px"
    modal.style.display = "block"
     modal.children[1].style.display = "block"
    modal.children[2].innerHTML = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti itaque libero eaque commodi maxime voluptates rem cupiditate cum mollitia? Aspernatur?"
})
cencle.addEventListener("click", function(){
    modal.style.display = "none"
})
cencle1.addEventListener("click", function(){
    modal.style.display = "none"
})
snd.addEventListener("click", function(){
    modal.children[1].style.display = "none"
    modal.children[2].innerHTML = "Malumotlar back-endga jo'natildi"
})
